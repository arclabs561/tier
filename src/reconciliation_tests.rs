...
mod tests {
    ...
    #[test]
    fn test_reconciliation_ols_star() {
        ...
        let y_tilde = reconcile(&s, &y_hat, ReconciliationMethod::Ols).unwrap();
    ...
    fn test_conformal_calibration() {
        ...
        cp.calibrate(&y_calib, &y_hat_calib, 0.2).unwrap();
    ...
    fn test_reconciliation_mint() {
        ...
        let y_tilde = reconcile(&s, &y_hat, ReconciliationMethod::MinT { covariance }).unwrap();
